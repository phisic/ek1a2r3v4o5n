...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_531b7d3b3a4f18_68088227',
  'has_nocache_code' => false,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_531b7d3b3a4f18_68088227')) {function content_531b7d3b3a4f18_68088227($_smarty_tpl) {?></div>
<div class="menu_wrapper">
	<div class="container">
        <div id="menu-wrap" class="clearfix desktop">
            <div id="menu-trigger">Категории<i class="menu-icon icon-plus-sign-alt"></i></div>
                <ul id="menu-custom">
                <li ><a href="http://presta.lan/index.php">Главная</a><ul><li ><a href="http://presta.lan/index.php?id_category=3&amp;controller=category&amp;id_lang=1">iPods</a></li><li ><a href="http://presta.lan/index.php?id_category=4&amp;controller=category&amp;id_lang=1">Accessories</a></li><li ><a href="http://presta.lan/index.php?id_category=5&amp;controller=category&amp;id_lang=1">Laptops</a></li></ul></li><li ><a href="http://presta.lan/index.php?id_category=3&amp;controller=category&amp;id_lang=1">iPods</a></li><li ><a href="http://presta.lan/index.php?id_category=4&amp;controller=category&amp;id_lang=1">Accessories</a></li>
                                    </ul>
            </div>
        </div>
