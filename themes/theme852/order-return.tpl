...
{if isset($orderRet)}
	<div class="titled_box"><h2><span>{l s='RE#'}<strong class="color-myaccount">{$orderRet->id|string_format:"%06d"}</strong> {l s='on'} {dateFormat date=$order->date_add full=0}</span></h2></div>
	<div>
	...
	<div id="order-detail-content" class="table_block">
		<table id="order-detail-content-table" class="table table-hover table-bordered table-responsive">
			<thead>
				<tr>
