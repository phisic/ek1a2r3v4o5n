...
{if $status == 'ok'}
   ...
   <ul>
	...
	<li><i class="icon-angle-right"></i>{l s='If you have questions, comments or concerns, please contact our' mod='bankwire'}<a class="cus-suport" href="{$link->getPageLink('contact', true)|escape:'html'}"><i class="icon-envelope-alt"></i>{l s='customer support' mod='bankwire'}</a>.</li>     
</div>
{else}
