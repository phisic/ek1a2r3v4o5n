...
<section  class="block myaccount column_box">
	...
	<div class="block_content toggle_content">
		...
		<p class="logout"><a class="button btn btn-default" href="{$link->getPageLink('index', true, NULL, "mylogout")|escape:'html'}" title="{l s='Sign out' mod='blockmyaccount'}">{l s='Sign out' mod='blockmyaccount'}</a></p>
	</div>
</section>
<!-- /Block myaccount module -->
