...
<em >			{l s='You have chosen to pay by check.' mod='cheque'}
	...
	<p class="cart_navigation clearfix">
		<input type="submit" name="submit" value="{l s='I confirm my order' mod='cheque'}" class="exclusive_large btn btn-default" />
		<a href="{$link->getPageLink('order', true, NULL, "step=3")|escape:'html'}" class="button_large btn btn-default">{l s='Other payment methods' mod='cheque'}</a>
	</p>
</form>
{/if}
