...
{if $status == 'ok'}
   ...
   <ul>
	...
	<li><i class="icon-angle-right"></i> {l s='For any questions or for further information, please contact our' mod='cheque'} <a class="cus-suport" href="{$link->getPageLink('contact', true)|escape:'html'}"><i class="icon-envelope-alt"></i>{l s='customer support' mod='cheque'}</a>.</li>
    </ul>
