...
<h4>{l s='Link' mod='blockpermanentlinks'}</h4>
    <ul class="list-footer toggle_content">
        <li class="sitemap">
            <a href="{$link->getPageLink('sitemap')|escape:'html'}">{l s='sitemap' mod='blockpermanentlinks'}</a>
        </li>
        <li class="contact">
            <a href="{$link->getPageLink('contact', true)|escape:'html'}">{l s='contact' mod='blockpermanentlinks'}</a>
        </li>
