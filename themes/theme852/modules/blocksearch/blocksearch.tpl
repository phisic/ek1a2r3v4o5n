...
<section id="search_block_left" class="block column_box">
	<h4 class="title_block"><span>{l s='Search' mod='blocksearch'}</span><i class="column_icon_toggle icon-plus-sign"></i></h4>
	<form method="get" action="{$link->getPageLink('search', true)|escape:'html'}" id="searchbox" class="toggle_content">
