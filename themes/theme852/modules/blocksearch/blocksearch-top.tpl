...
<section id="search_block_top" class="header-box">
	<form method="get" action="{$link->getPageLink('search')|escape:'html'}" id="searchbox">
        ...
        <a class="btn btn-default button btn_add_cart" href="javascript:document.getElementById('searchbox').submit();"><i class="icon-search"></i><span>{l s='Search' mod='blocksearch'}</span></a>
	</form>
</section>
