...
<section id="manufacturers_block_left" class="block blockmanufacturer column_box">
	<h4 class="title_block">{if $display_link_manufacturer}<span>{/if}{l s='Manufacturers' mod='blockmanufacturer'}{if $display_link_manufacturer}</span>{/if}<i class="column_icon_toggle icon-plus-sign"></i></h4>
