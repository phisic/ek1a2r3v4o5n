<div id="opc_new_account" class="opc-main-block">
	...
	<h1><span>1</span> {l s='Account'}</h1>
	<form action="{$link->getPageLink('authentication', true, NULL, "back=order-opc")|escape:'html'}" method="post" id="login_form" class="std">
		<fieldset>
			<div class="titled_box"><h2><span>{l s='Already registered?'}</span></h2></div>
			<p><a href="#" class="button btn btn-default" id="openLoginFormBlock">{l s='Click here'}</a></p>
	...
	<form action="javascript:;" method="post" id="new_account_form" class="std" autocomplete="on" autofill="on">
		<fieldset>
			...
			<div class="titled_box"><h2 id="new_account_title">{l s='New Customer'}</h2></div>
			<div id="opc_account_choice">
				<div class="opc_float">
					<h4>{l s='Instant Checkout'}</h4>
					<p>
						<input type="button" class="exclusive_large btn btn-default" id="opc_guestCheckout" value="{l s='Guest checkout'}" />
					</p>
				</div>
				...
				<div class="opc_float">
					...
					<p>
						<input type="button" class="button_large btn btn-default" id="opc_createAccount" value="{l s='Create an account'}" />
					</p>
				</div>
				<div class="clear"></div>
			</div>
			<div id="opc_account_form">
				...
				<p class="required password is_customer_param form-group">
					...
					<small class="form_info">{l s='(five characters min.)'}</small>
				</p>
                ...
                <div class="titled_box">
                	<h2><span>{l s='Delivery address'}</span></h2>
                </div>
				{$stateExist = false}
				{$postCodeExist = false}
				{$dniExist = false}
				...
				<p class="form-group is_customer_param">
					...
					<input type="text" class="form-control" name="address2" id="address2" value="{if isset($guestInformations) && $guestInformations.address2}{$guestInformations.address2}{/if}" />
				</p>
				...
				<div id="opc_invoice_address" class="titled_box is_customer_param">
					...
					<h2><span>{l s='Invoice address'}</span></h2>
				  ...
				  <div id="vat_number_block_invoice" class="is_customer_param" style="display:none;">
					...
					<p class="required form-group">
						...
						<input type="text" class="form-control" id="firstname_invoice" name="firstname_invoice" value="{if isset($guestInformations) && $guestInformations.lastname_invoice}{$guestInformations.lastname_invoice}{/if}" />
					</p>
					{elseif $field_name eq "lastname"}
					<p class="required form-group">
				...
				<p class="submit">
					<input type="submit" class="exclusive button btn btn-default" name="submitAccount" id="submitAccount" value="{l s='Save'}" />
				</p>
