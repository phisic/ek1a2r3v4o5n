...
{/if}
	<div class="addresses clearfix">
		...
		<p id="address_invoice_form" class="form-group" {if $cart->id_address_invoice == $cart->id_address_delivery}style="display: none;"{/if}>
		...
		{else}
			<a href="{$link->getPageLink('address', true, NULL, "back={$back_order_page}?step=1{'&multi-shipping=1'|urlencode}{if $back}&mod={$back}{/if}")|escape:'html'}" title="{l s='Add'}" class="button_large btn btn-default">{l s='Add a new address'}</a>
		{/if}
		</p>
		<div class="clearfix">
        	<div class="row">
		...
		<p class="address_add submit">
			<a href="{$link->getPageLink('address', true, NULL, "back={$back_order_page}?step=1{'&multi-shipping=1'|urlencode}{if $back}&mod={$back|urlencode}{/if}")|escape:'html'}" title="{l s='Add'}" class="button_large btn btn-default">&raquo; {l s='Add a new address'}</a>
		</p>
		{if !$opc}
...
{if !$opc}
	<p class="cart_navigation clearfix submit">
		...
		{if $back}
			<a href="{$link->getPageLink('order', true, NULL, "step=0&amp;back={$back}")|escape:'html'}" title="{l s='Previous'}" class="button btn btn-default">&laquo; {l s='Previous'}</a>
		{else}
			<a href="{$link->getPageLink('order', true, NULL, "step=0")|escape:'html'}" title="{l s='Previous'}" class="button btn btn-default">&laquo; {l s='Previous'}</a>
		{/if}
