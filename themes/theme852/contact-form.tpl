...
{if isset($confirmation)}
	<p class="alert alert-success">
    	...
    	<i class="icon-ok"></i>{l s='Your message has been successfully sent to our team.'}</p>
...
{else}
	...
	<form id="contact_form" action="{$request_uri|escape:'htmlall':'UTF-8'}" method="post" class="std" enctype="multipart/form-data">
		...
		<div class="submit">
			<input  class="button btn btn-default" type="submit" name="submitMessage" id="submitMessage" value="{l s='Send'}"/>
		</div>
	</fieldset>
</form>
{/if}
